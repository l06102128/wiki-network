...
class DictionaryField(models.Field):
    # Django seems to do some funky stuff prohibiting this class from
    # inheriting from PickledObjectField which I can't be bothered to explore.
    ...
    def get_db_prep_lookup(self, lookup_type, value):
        if lookup_type == 'exact':
            ...
            return super(DictionaryField, self).get_db_prep_lookup(lookup_type,
                                                                   value)
        elif lookup_type == 'in':
